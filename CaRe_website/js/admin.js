...
function loadPatients() {
    ...
    const endpoint = searchQuery ? `../API/patients_api.php?functionname=getPatients&search=${searchQuery}` : `../API/patients_api.php?functionname=getPatients&page=${currentPage}`;
...
function addPatient() {
    ...
    fetch('../API/patients_api.php?functionname=addPatient', {
        method: 'POST',
        headers: {
...
function searchPatients() {
    ...
    let queryString = `../API/patients_api.php?search=${searchQuery}&gender=${genderFilter}&ageMin=${ageMin}&ageMax=${ageMax}&functionname=getPatients`;
...
function openPatientForm(id = null) {
    ...
    if (typeof id === 'number' && !isNaN(id)) {
        fetch(`../API/patients_api.php?functionname=getPatient&id=${id}`)
            .then(response => response.json())
            .then(patient => {
...
function submitPatientForm(functionanme) {
    if (functionanme === "addPatientModal") {
        ...
        const endpoint = `../API/patients_api.php?functionname=${patientId ? 'updatePatient' : 'addPatient'}`;
        fetch(endpoint, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
        ...
        fetch('../API/schedule_api.php?functionname=getAppointments')
            .then(response => response.json())
            .then(data => {
...
async function submitAppointmentForm(type) {
    ...
    if (type) {
        ...
        try {
            const response = await fetch('../API/schedule_api.php?functionname=updateAppointment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        try {
            const response = await fetch('../API/schedule_api.php?functionname=addAppointment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
function openEditAppointmentForm(eventId) {
    ...
    fetch(`../API/schedule_api.php?functionname=getAppointment&id=${eventId}`)
        .then(response => response.json())
        .then(appointment => {
...
function generateCharts() {
    ...
    fetch('../API/schedule_api.php?functionname=getPatientStats')
        .then(response => response.json())
        .then(data => {
    ...
    fetch('../API/schedule_api.php?functionname=getAppointmentStats')
        .then(response => response.json())
        .then(data => {
...
function loadTherapists() {
    return fetch('../API/schedule_api.php?functionname=getTherapists')
        .then(response => response.json())
        .then(data => {
...
function loadTreatmentRooms() {
    return fetch('../API/schedule_api.php?functionname=getTreatmentRooms')
        .then(response => response.json())
        .then(data => {
